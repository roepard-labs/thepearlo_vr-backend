...
/**
 * Modelo: LegalTerms
 * Gestión de contenido de Términos y Condiciones
...
class LegalTerms
{
    ...
    /**
     * Obtener todo el contenido de términos activo (para vista pública)
     */
    public function getAllActive(): array
    {
        try {
            ...
            throw new Exception("Error al obtener términos: " . $e->getMessage());
        }
    }
     ...
     */
    public function getById($termId): mixed
    {
        try {
            $sql = "SELECT * FROM legal_terms WHERE term_id = :id";
            $stmt = $this->db->prepare($sql);
            $stmt->bindParam(':id', $termId, PDO::PARAM_INT);
            $stmt->execute();
     ...
     */
    public function update($termId, $data): bool
    {
        try {
            $sql = "UPDATE legal_terms SET
     ...
     */
    public function delete($termId, $updatedBy): bool
    {
        try {
            $sql = "UPDATE legal_terms 
    ...
    {
        try {
            $sql = "SELECT * FROM legal_metadata WHERE document_type = 'terms'";
            $stmt = $this->db->prepare($sql);
            $stmt->execute();
