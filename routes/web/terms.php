<?php
/**
 * Ruta API Pública: Obtener Términos y Condiciones
 * GET /routes/web/terms.php
 * 
 * Retorna el contenido activo de los términos y condiciones
...
try {
    ...
    echo json_encode([
        'status' => 'error',
        'message' => 'Error al obtener términos y condiciones: ' . $e->getMessage()
