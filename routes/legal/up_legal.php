<?php
/**
 * Ruta API Admin: Actualizar Términos y Condiciones
 * PUT /routes/legal/up_legal.php
 * 
 * Permite crear, actualizar o eliminar párrafos de términos
...
require_once __DIR__ . '/../../models/LegalTerms.php';
...
try {
    ...
    switch ($operation) {
        ...
        case 'update':
            // Validar ID
            if (!isset($input['term_id']) || empty($input['term_id'])) {
                http_response_code(400);
                echo json_encode([
                    'status' => 'error',
